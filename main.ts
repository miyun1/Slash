...
function PlayerHealthSB () {
    RuyolHPBar = statusbars.create(6, 40, StatusBarKind.Health)
    RuyolHPBar.setColor(8, 15, 9)
    RuyolHPBar.setLabel("HP")
    RuyolHPBar.setBarBorder(2, 15)
    RuyolHPBar.positionDirection(CollisionDirection.Left)
    RuyolHPBar.setOffsetPadding(-18, 3)
    RuyolHPBar.value = 100
    RuyolHPBar.max = 100
    RuyolHPBar.setStatusBarFlag(StatusBarFlag.SmoothTransition, true)
}
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    music.play(music.createSoundEffect(WaveShape.Square, 1734, 2076, 148, 83, 100, SoundExpressionEffect.Tremolo, InterpolationCurve.Curve), music.PlaybackMode.InBackground)
    console.log(stance)
})
...
let catSpeed = 0
let stance = 0
let RuyolHPBar: StatusBarSprite = null
let Ruyol: Sprite = null
let CatBoss: Sprite = null
game.splash("MOONMAN RIDER", "the game")
LevelSetup()
MusicSetup()
PlayerSetup()
bossSetup()
